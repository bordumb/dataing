"""Unified data source adapter layer - Community Edition.

This module provides a pluggable adapter architecture that normalizes
heterogeneous data sources (SQL databases, NoSQL stores, file systems)
into a unified interface.

Core Principle: All sources become "tables with columns" from the frontend's perspective.

Note: Premium API adapters (Salesforce, HubSpot, Stripe) are available in Enterprise Edition.
"""
