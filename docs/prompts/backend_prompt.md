# DataDr v2 Gap Analysis & Implementation Prompt
...
You are implementing features for DataDr v2, an autonomous data quality investigation system. The codebase follows hexagonal architecture with Python/FastAPI backend and React/TypeScript frontend.
